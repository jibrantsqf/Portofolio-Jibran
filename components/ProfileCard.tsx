              ...
              {showUserInfo && (
                ...
                >
                  ...
                  <a
                    ...
                    style={{ pointerEvents: 'auto', display: 'block', gridArea: 'auto', borderRadius: '8px', textDecoration: 'none' }}
              ...
              <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  ...
                  style={{
                    ...
                    textShadow: '0px 4px 15px rgba(0, 0, 0, 0.9), 0px 1px 3px rgba(0, 0, 0, 0.8)', /* Efek bayangan gelap agar teks menonjol */
                    display: 'block',
                    gridArea: 'auto',
                    borderRadius: '0',
                    pointerEvents: 'auto'
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '18px',
                    margin: '0 auto',
                    color: '#f8fafc', /* Warna putih agak terang */
                    textShadow: '0px 4px 15px rgba(0, 0, 0, 0.9), 0px 1px 3px rgba(0, 0, 0, 0.8)', /* Bayangan gelap */
                    display: 'block',
                    gridArea: 'auto',
                    borderRadius: '0',
                    pointerEvents: 'auto'
